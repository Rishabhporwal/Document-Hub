...
class ConversationalRAG:
    ...
    def __init__(self, session_id: Optional[str], retriever=None):
        try:
            ...
            raise DocumentHubException("Initialization error in ConversationalRAG", sys)
    ...
    def load_retriever_from_faiss(
        ...
        try:
            ...
            raise DocumentHubException("Loading error in ConversationalRAG", sys)

    def invoke(self, user_input: str, chat_history: Optional[List[BaseMessage]] = None) -> str:
        """Invoke the LCEL pipeline."""
        try:
            if self.chain is None:
                raise DocumentHubException(
            ...
            raise DocumentHubException("Invocation error in ConversationalRAG", sys)
    ...
    def _load_llm(self):
        try:
            ...
            raise DocumentHubException("LLM loading error in ConversationalRAG", sys)
    ...
    def _build_lcel_chain(self):
        try:
            if self.retriever is None:
                raise DocumentHubException("No retriever set before building chain", sys)
            ...
            raise DocumentHubException("Failed to build LCEL chain", sys)