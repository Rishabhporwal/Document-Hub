...
class SingleDocIngestor:
    def __init__(self, data_dir: str = "data/simgle_document_chat", faiss_dir: str = "faiss_index"):
        try:
            ...
            self.log.info("SingleDocIngestor initializes", temp_path = {self.data_dir}, faiss_dir={self.faiss_dir})
