...
class FaissManager:
    ...
    def load_or_create(self,texts:Optional[List[str]]=None, metadatas: Optional[List[dict]] = None):
        if self._exists():
            ...
            return self.vs
        if not texts:
            raise DocumentHubException("No existing FAISS index and no data to create one", sys)
...
class ChatIngestor:
    def __init__( self,
        ...
        try:
            ...
            raise DocumentHubException("Initialization error in ChatIngestor", e) from e
    ...
    def built_retriver( self,
        ...
        *,
        ...
        try:
            ...
            raise DocumentHubException("Failed to build retriever", e) from e
...
class DocHandler:
    ...
    def save_pdf(self, uploaded_file) -> str:
        try:
            ...
            raise DocumentHubException(f"Failed to save PDF: {str(e)}", e) from e
    ...
    def read_pdf(self, pdf_path: str) -> str:
        try:
            ...
            raise DocumentHubException(f"Could not process PDF: {pdf_path}", e) from e
class DocumentComparator:
    ...
    def save_uploaded_files(self, reference_file, actual_file):
        try:
            ...
            raise DocumentHubException("Error saving files", e) from e
    ...
    def read_pdf(self, pdf_path: Path) -> str:
        try:
            ...
            raise DocumentHubException("Error reading PDF", e) from e
    ...
    def combine_documents(self) -> str:
        try:
            ...
            raise DocumentHubException("Error combining documents", e) from e
    ...
    def clean_old_sessions(self, keep_latest: int = 3):
        try:
            ...
            raise DocumentHubException("Error cleaning old sessions", e) from e