...
class ModelLoader:
    ...
    def _validate_env(self):
        """
            validate necessaary environment variables.
        ...
        if missing:
            ...
            raise DocumentHubException("Missing Enviroment variables", sys)
    ...
    def load_embeddings(self):
        ...
        try:
            ...
            log.error("Error while loading Embedding models", error=str(e))

    def load_llm(self):
        """
            Load and return the LLM models.
            load LLM dynamically based on provided config
        """
        ...
        max_tokens = llm_config.get('max_token', 2048)
...
if __name__ == "__main__":
    ...
    print(f"Embedidng Results: {result}")
